...
Ambos scripts se apoyan del script conjunto "utils.sh" para el manejo de errores, por lo que ambos scripts dependen de la presencia de este script auxiliar.
